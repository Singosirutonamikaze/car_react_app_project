...
function CTASection() {
    ...
    return (
        <div ref={containerRef} className="text-center">
            <h2
                ref={titleRef}
                className="text-3xl font-bold client-theme-text-primary mb-6 transition-colors duration-300"
            >
                Prêt à trouver votre véhicule idéal?
            </h2>
            <p
                ref={textRef}
                className="text-xl client-theme-text-secondary mb-8 max-w-2xl mx-auto transition-colors duration-300"
            >
            ...
            <button
                ...
                className="client-theme-button font-semibold py-4 px-8 rounded-xl transition-all duration-300 hover:scale-105 active:scale-95 hover:shadow-2xl border"
            >
