...
function LocationCard() {
    ...
    return (
        <div
            ref={cardRef}
            className="client-theme-card-soft backdrop-blur-md rounded-2xl p-8 border h-64 flex items-center justify-center transition-all duration-300 group cursor-pointer"
        >
            <div className="text-center client-theme-text-secondary transition-colors duration-300">
