...
function CardStyle() {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="mb-10 max-w-3xl client-page-heading-wrap">
                <h2 className="client-page-heading">Notre Collection</h2>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${car.disponible
                                        ? "client-theme-button border cursor-pointer"
            ...
            {cars.length === 0 && (
                <div className="text-center py-12">
                    <div className="client-theme-text-secondary client-theme-card-soft p-6 rounded-xl border">
                        ...
                        <h3 className="text-xl font-semibold client-theme-text-primary mb-2">Aucune voiture disponible</h3>
