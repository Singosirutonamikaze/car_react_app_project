...
const options = {
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description: 'API REST complète pour la gestion de ventes, commandes et locations de voitures.',
            contact: {
    ...
    apis: [
        node_path_1.default.join(__dirname, '../routes/*.ts'),
        node_path_1.default.join(__dirname, '../routes/*.js'),
    ],
};
